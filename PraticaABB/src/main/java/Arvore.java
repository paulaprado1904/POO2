/*Nesta classe de teste, há apenas 8 testes, pois os métodos de inserção são validados
em todos eles, uma vez que só é possível buscar e remover um dado que já foi inserido*/
